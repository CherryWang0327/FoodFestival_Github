...
├── user_registration.jsp        # 注册页：游客信息登记表单  （喵喵负责）如果event_registration和user-registration的 UI 风格高度相似，可以让“喵喵”考虑是否能合并为一个通用模板，通过 Request 参数来区分是“活动报名”还是“用户注册”，或者共用一套 CSS 样式，减少冗余代码。

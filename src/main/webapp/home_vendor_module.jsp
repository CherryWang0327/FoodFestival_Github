    ...
    <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div class="bg-white p-8 rounded-2xl shadow-md text-center hover:-translate-y-2 transition-all">
                <img src="https://images.unsplash.com/photo-1577214190218-3a4d36ee408d?w=200" class="w-24 h-24 rounded-full mx-auto mb-4 object-cover border-4 border-orange-100">
                ...
                <a href="vendor.jsp" class="text-orange-500 font-bold hover:underline">Explore Menu →</a>
            </div>
